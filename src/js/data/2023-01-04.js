...
dataSet[dataSetVersion].options = [
  {
    ...
    checked: true,
    sub: [
      { name: "Evanescent Existence", tooltip: "1 - Mugenri", key: "EE" },
      { name: "Earthen Miraculous Sword", tooltip: "2 - Tasouken", key: "EMS" },
      { name: "Reactivate Majestical Imperial", tooltip: "3 - Reiretsuden", key: "RMI" },
      { name: "Brilliant Pagoda or Haze Castle", tooltip: "4 - Ten'eisenki", key: "BPOHC" },
      { name: "Book of the Cafe", tooltip: "0 - Len'en Cafe", key: "BOTC" },
      { name: "Other", tooltip: "Monochroids, Hoojiro, and Haru", key: "MISC" },
    ]
  },
  {
    ...
    checked: false,
    sub: [ { name: "Stage 1", key: "st1" }, { name: "Stage 2", key: "st2" }, { name: "Stage 3", key: "st3" }, { name: "Stage 4", key: "st4" }, { name: "Stage 5", key: "st5" }, { name: "Stage 6", key: "st6" }, { name: "Stage EX", key: "ex" }
    ]
  }
];
...
dataSet[dataSetVersion].characterData = [
  {
    ...
    img: "c5DqpgX.png",
    opts: {
      series: [ "EE", "EMS", "RMI", "BPOHC" ],
      stage: ["st3", "st4", "st6"]
    }
  },
  {
    name: "Tsubakura Enraku",
    img: "tJnkSzK.png",
    opts: {
      series: [ "EE", "EMS", "RMI", "BPOHC" ],
      stage: ["st3", "st4", "st6"]
